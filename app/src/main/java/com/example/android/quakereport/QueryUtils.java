...
public final class QueryUtils {
    ...
    public static ArrayList<EarthquakeClass> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray jsonArray = jsonObjectRoot.optJSONArray("features");
            ...
            for (int i = 0; i < jsonArray.length(); i++){
                ...
                JSONObject jsonObjectProperties = jsonObject1.optJSONObject("properties");
                Double mag = jsonObjectProperties.optDouble("mag");
                String place = jsonObjectProperties.optString("place");
                Long time = jsonObjectProperties.optLong("time");
                String url = jsonObjectProperties.optString("url");

                //Create Earthquake java object from magnitude, location, and time
                earthquakes.add(new EarthquakeClass(mag, place, time, url));
            }
